...
public class FrontController extends HttpServlet {
	...
	// Map<key타입, value타입>
	// key타입 -> String지정 why? 사용자의 요청이 들어오면 
	// "/insert.do"와 같은 식별값을 활용해서 구분
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		// : 페이지에서는 모든 요청에 .do를 붙여야 하나의 서블릿으로 오게 됨
		// 단점
		// : 한 곳에 중앙집중화 되면서 로직이 길어지고 하나의 기능이 문제가 생기면
		// 	 모근 기능을 사용할 수 없게 된다는 문제점이 발생! -> 일반 클래스파일로 기능들을 분리
		...
		// : 일반클래서에 implements 키워드를 이용해서 인터페이스를 구현
